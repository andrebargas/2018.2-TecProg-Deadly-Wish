       ...
       character_code(character_code)
{
    ...
    //! initializing Character - Técnica de agrupamento de informações relacionadas.
...
Character::update_position(const unsigned &now, const unsigned &last, bool backwards) {
    ...
    //! Técnica de agrupamento de informações relacionadas.
...
//! Técnica - função modularizada
bool
Character::on_event_defense(const GameEvent& event)
{
  ...
  if((p1_defense_validation || p2_defense_validation || p3_defense_validation || p4_defense_validation) &&
...
//! Técnica - função modularizada(Handle heavy atack event)
bool
Character::on_event_heavy_atack(const GameEvent& event)
{
  ...
  if((p1_heavy_attack_validation || p2_heavy_attack_validation ||
      p3_heavy_attack_validation || p4_heavy_attack_validation) &&
...
//! Técnica - função modularizada (Handle Ligth atack atack of character event )
bool
Character::on_event_ligth_atack(const GameEvent& event)
{
  ...
  if((p1_light_attack_validation || p2_light_attack_validation || p3_light_attack_validation || p4_light_attack_validation) &&
...
//! Técnica - função modularizada (Handle Special atack of character event)
bool
Character::on_event_special(const GameEvent& event)
{
  ...
  if((p1_special_validation || p2_special_validation || p3_special_validation || p4_special_validation) &&
...
//!Técnica - função modularizada (Handle Movement of character event)
bool
Character::on_event_movement(const GameEvent& event)
{
...
//! Técnica de modularização de funções
bool
Character::on_event(const GameEvent& event)
{

    //! Control events atack and defense of character
    ...
    //! Control movement character event
...
//! Respawn Character
//! Técnica de agrupamento de informações relacionadas (Páragrafos de funções)
void
Character::respawn_character()
{
    ...
    //!initializing character to respawn
